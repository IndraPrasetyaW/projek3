...
<div class="site-landing">
    <div class="container">
        <h1>Produk Laptop Unggulan Kami</h1>
        <br>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <br><br>
                <p> fitur unggulan lain dari Samsung AU7002 adalah motion Xcelerator, Q-symphony sound, dan multiple
                    voice assistant.</p>
                <br><br>
            ...
            <div class="col-md-4">
                ...
                <p>Rekomendasi smart TV 43 inch ini sudah dilengkapi dengan sistem operasi Android 11 yang mudah
                    dioperasikan.
